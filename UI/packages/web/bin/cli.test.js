...
describe('isOpenchamberCmdline', () => {
  ...
  it('accepts a real globally-installed suplagentics package (renamed fork, no "openchamber" in its path)', () => {
    expect(isOpenchamberCmdline('node /usr/lib/node_modules/suplagentics/bin/cli.js serve')).toBe(true);
    expect(isOpenchamberCmdline('node C:\\Users\\friend\\AppData\\Roaming\\npm\\node_modules\\suplagentics\\bin\\cli.js serve')).toBe(true);
  });
