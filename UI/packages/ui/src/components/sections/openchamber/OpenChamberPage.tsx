...
import { ImportSettings } from '../suplagentics/ImportSettings';
import { ImprovementSettings } from '../suplagentics/ImprovementSettings';
import { IndexingSettings } from '../suplagentics/IndexingSettings';
...
export const OpenChamberPage: React.FC<OpenChamberPageProps> = ({ section }) => {
    ...
    const renderSectionContent = () => {
        switch (section) {
            ...
            case 'indexing':
                return <IndexingSectionContent />;
            case 'import':
                return <ImportSectionContent />;
            case 'improvement':
                return <ImprovementSectionContent />;
            default:
                return null;
        }
    };
...
const IndexingSectionContent: React.FC = () => {
    if (isVSCodeRuntime()) {
        return null;
    }
...
const ImportSectionContent: React.FC = () => {
    if (isVSCodeRuntime()) {
        return null;
    }
...
const ImprovementSectionContent: React.FC = () => {
    if (isVSCodeRuntime()) {
        return null;
    }
