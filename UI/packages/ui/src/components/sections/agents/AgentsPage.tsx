...
export const AgentsPage: React.FC = () => {
  ...
  return (
    <ScrollableOverlay outerClassName="h-full" className="w-full">
      {/* @container, not viewport @sm:/md: — this page renders inside a variable-width column
          (settings nav + a fixed-width agent list already eat into the browser's own viewport
          width before this ever gets space), so a viewport-width breakpoint can report "wide
          enough" even when the actual rendered column is much narrower, causing rows to overflow
          instead of stacking. Verified live: at ~900px total viewport width with the desktop
          3-column settings layout, @sm: (640px) was satisfied by the viewport while the real
          column had well under 640px, overflowing the Tool Permissions rows off-screen. */}
      <div className="@container mx-auto w-full max-w-3xl p-3 @@sm:p-6 @@sm:pt-8">
        ...
        <div data-settings-item="agents.permissions" className="mb-2">
          <div className="mb-1 px-1 flex flex-wrap items-center justify-between gap-2">
            <h3 className="typography-ui-header font-medium text-foreground">
