...
export const dict: Record<I18nKey, string> = {
  ...
  "rightSidebar.contextNotesTodo.plans.reviewPlan": "Review & annotate plan",
  "rightSidebar.contextNotesTodo.plans.completed": "Completed",
  "rightSidebar.contextNotesTodo.plans.completedAt": "Completed {at}",
  "rightSidebar.contextNotesTodo.plans.reviewPlanWithTitle": "Review & annotate plan \"{title}\"",
  ...
  "rightSidebar.contextNotesTodo.toast.planFeedbackSent": "Feedback sent to the planning session",
  "rightSidebar.contextNotesTodo.toast.planFeedbackFailed": "Failed to send plan feedback",
  "rightSidebar.contextNotesTodo.toast.planBuildContinued": "Building in the original plan session — opening the chat",
  "rightSidebar.contextNotesTodo.toast.planBuildStartedNew": "Original plan session is gone — started a new build session",
  "rightSidebar.contextNotesTodo.toast.planBuildFailed": "Failed to start the build",
  "rightSidebar.contextNotesTodo.toast.planFeedbackStartedNewSession": "No existing session found for this plan — started a new review session instead",
