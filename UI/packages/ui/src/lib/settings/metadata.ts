...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  { slug: 'indexing', title: 'Indexing', group: 'advanced', kind: 'single', keywords: ['indexing', 'indexer', 'summarizer', 'local model', 'ollama', 'memory', 'pipeline', 'insights', 'stalled'], isAvailable: (ctx) => !ctx.isVSCode },
  { slug: 'import', title: 'Import History', group: 'advanced', kind: 'single', keywords: ['import', 'claude code', 'opencode', 'memory', 'memories', 'history', 'sessions'], isAvailable: (ctx) => !ctx.isVSCode },
  { slug: 'improvement', title: 'Improvements', group: 'advanced', kind: 'single', keywords: ['improvement', 'suggestions', 'skills', 'agents', 'workflows', 'investigate', 'insights'], isAvailable: (ctx) => !ctx.isVSCode },
